        ...
        <div className="relative">
            ...
            <button onClick={onToggle} className="flex items-center space-x-3 p-2 rounded-xl hover:bg-gray-50 transition-colors duration-200">
                {avatar ? (
                    ...
                    <div className="h-8 w-8 bg-gradient-to-br from-green-900 to-green-800 rounded-xl flex items-center justify-center">
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50">
                    ...
                    <a
                        href="#"
                        onClick={onLogout}
                        className="block px-4 py-2 textt-sm text-red-600 hover:bg-red-50 transition-colors"
                    >
                        Sign out
                    </a>
